...
<head>
    ...
    <script src="<?php echo assets_url() ?>js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="<?php echo assets_url() ?>js/plugins/flot/curvedLines.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="<?php echo assets_url() ?>js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?php echo assets_url() ?>js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li<?php if($class=='user' || $class=='group' || $class=='permission') echo ' class="active"'?>>
                ...
                <li<?php if($class=='menu' || $class=='article' || $class=='category' || $class=='media') echo ' class="active"'?>>
                    <a href="#"><i class="fa fa-file-text"></i> <span class="nav-label">Konten</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="#">Menu</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a class="dropdown-item float-left" href="profile.html">
                                    <img alt="image" class="rounded-circle" src="<?php echo assets_url() ?>img/a7.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a class="dropdown-item float-left" href="profile.html">
                                    <img alt="image" class="rounded-circle" src="<?php echo assets_url() ?>img/a4.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a class="dropdown-item float-left" href="profile.html">
                                    <img alt="image" class="rounded-circle" src="<?php echo assets_url() ?>img/profile.jpg">
                                </a>
                                <div>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="<?php echo assets_url() ?>img/a7.jpg">
                                    </div>
                                    <div class="media-body">
